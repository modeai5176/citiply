  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <p className="mt-4 max-w-2xl text-text-secondary">Browse categories across all product families and move quickly into curated architectural collections.</p>
